...
## Completion
[] - After completing a task, use a review agent with the /thermo-nuclear-code-quality-review skill to compare the output against what was requested. Fix issues with a worker agent
